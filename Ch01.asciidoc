...
Decentralized blockchains money projects are clunky and slow compared to current ledgers, but this can be considered an upside because it takes more energy and resources for any one participant or group of particpants to attack and control.
