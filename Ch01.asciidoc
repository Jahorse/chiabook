...
Bram Cohen's reinvention of Nakamoto Consensus-:: The main reason is for less energy usage per unit of security, but all technical decisions were re-examined and many were upgraded significantly. In practice, many are more in line with the goals of the original cypherpunks whose enthusiasm drove bitcoin in the early days. Many of the shortcomings of bitcoin in terms of potential velocity of exchange and privacy aspects are trivially implemented using chialisp programming language. Chialisp is the lisp-based smart coin programming language for Chia Blockchain and it's clones representing no side effects and minimal "syntactic sugar" giving it secuirty and stability. The gained efficiency of chia consensus and the technical gains of chialisp go a long way at representing the foundation for the greatest feature improvements of chia over bitcoin and should only increase the gap over time. 
Chia Corporation:: formed around the project.
21 million XCH Pre-farm:: Chia Corporate control mechanism. Centralization concerns.
