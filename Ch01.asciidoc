...
Decentralized blockchain definition - A secured, distributed ledger; where in the case of a cryptocurrency "ledger" is defined as a record of value (AKA money) along with timestamps. 
