...
Decentralized blockchain definition - Distributed, secured ledger where in the case of cryptocurrency "ledger" is defined as unspent value (AKA money) entries along with their timestamps. 
