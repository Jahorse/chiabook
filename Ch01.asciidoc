...
General blockchain technology value - Hard to duplicate as it becomes longer and heavier, but it is slow when decentralized. Suprisingly little value added from a traditional database or ledger.
