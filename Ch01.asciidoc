...
Bram Cohen's re-invention of Nakamoto Consensus-:: The main reason is for less energy usage per unit of security, but all technical decisions were re-examined and many were upgraded significantly and are more in line with the goals of the original cypherpunks whose enthusiasm drove bitcoin in the early days. Chialisp is a lisp-based smart coin programming language representing no side effects and minimal "syntactic sugar" for stability and represents perhaps the foundation of the greatest feature improvements of chia over bitcoin. 
